...
public abstract class DirectedGame implements ApplicationListener
{
    ...
    public void set_screen (AbstractGameScreen screen)
    {
        set_screen(screen, null);
    }

    public void set_screen (AbstractGameScreen screen, ScreenTransition screenTransition)
    {
...
// get delta time and ensure an upper limit of one 60th second
        ...
        else
        {
            // ongoing transition
            float duration = 0;
            if (screenTransition != null) {duration = screenTransition.get_duration();}

            // update progress of ongoing transition
            transition_timer = Math.min(transition_timer + deltaTime, duration);

            if (screenTransition == null || transition_timer >= duration)
            {
            ...
            else
            {
                ...
                float alpha = transition_timer / duration;
